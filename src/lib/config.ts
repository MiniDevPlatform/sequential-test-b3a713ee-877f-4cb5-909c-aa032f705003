...
export const PROJECT = {
  ...
  version: '1.0.0',
  license: 'GPL-3.0',
  url: 'https://sequential-test.minidev.app',
  repository: 'https://github.com/MiniDevPlatform/sequential-test',
} as const;
...
export const FEATURES = {
  ...
  // Campaign
  campaign: { enabled: false, levels: [], achievements: [], saveProgress: true, saveKey: 'sequential-test_progress' },
